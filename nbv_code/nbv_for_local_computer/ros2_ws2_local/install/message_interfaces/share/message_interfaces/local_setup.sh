...
: ${AMENT_CURRENT_PREFIX:="/home/rmml05/Best_View/nbv_JaJaYu/TomatoHarvesting_NextBestView/nbv_code/nbv_for_local_computer/ros2_ws2_local/install/message_interfaces"}
