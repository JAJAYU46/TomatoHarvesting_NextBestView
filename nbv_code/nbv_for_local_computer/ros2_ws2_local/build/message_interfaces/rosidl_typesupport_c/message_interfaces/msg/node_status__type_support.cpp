...
static const _NodeStatus_type_support_symbol_names_t _NodeStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_interfaces, msg, NodeStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, message_interfaces, msg, NodeStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, message_interfaces, msg, NodeStatus)() {
  return &::message_interfaces::msg::rosidl_typesupport_c::NodeStatus_message_type_support_handle;
}
