...
class DetectTomato:
    ...
    def __init__(self, image, resizeMag=1):
        ...
        self.resizeMagForText=resizeMag*1/3
    ...
    def __ExtractTrackAndReturnTopAndTarget(self,tracked_objects, image):
        ...
        for track in tracked_objects:
            ...
            if det_conf is None:
                ...
                # 好像這像是給id追蹤的時候, 如果那個id的tomato不見, id也不會完全消失, 為了追蹤, 它會留一下在見見消失
                # 所以for visualization, 這個是0的就不印出來了
                det_conf = 0.0  # Default confidence if none is found
                
            if(IS_DEBUG==True): 
                #Top Tomato # renew at 20250305 y1<self.TopTomatoTrackY => y1>self.TopTomatoTrackY tallest is y highest 
...
if __name__ == '__main__':
    ...
    # if not ret:
    #     print("End of video.")
    frame1 = cv2.imread("dataset/data_tomatoVideo_forDetection/TomatoImage.png")
