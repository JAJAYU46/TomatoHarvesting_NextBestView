...
//                     std::vector<octomap::point3d> directions = RandomPoint(origin, 10, 5); //其實不用太長, 反正它只是個方向
...
//                     publish_multiple_rays_and_directions(origin, directionsV, hitpointV);
...
//         // {
//         void publish_multiple_rays_and_directions(const octomap::point3d &origin, const std::vector<octomap::point3d> &hitPoints, const std::vector<octomap::point3d> &directions) {
...
//             ray_marker.scale.x = 0.005;  // Line width
...
//             direction_marker.type = visualization_msgs::msg::Marker::ARROW;//ARROW;
//             direction_marker.action = visualization_msgs::msg::Marker::ADD;
//             direction_marker.scale.x = 0.05;  // Arrow shaft width 0.05  0.01
...
//                 arrow_end.y = origin.y() + directions[i].y() * 0.5;
