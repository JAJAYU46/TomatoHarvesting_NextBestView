...
class SdfModel {
public:
    SdfModel(const std::string& ply_file_path, float radius, int num_points)
...
{   //ROS2
    ...
    // string ply_file_path="src/dataset/data_pcd/TomatoPlant_size_modified_only1tomato.ply";
    // open3d::geometry::PointCloud pcd = open3d::io::CreatePointCloudFromFile(ply_file_path); 

    // SdfModel processor(pcd, 0.2f, 5000);



    SdfModel processor("src/dataset/data_pcd/TomatoPlant_size_modified_only1tomato.ply", 0.2f, 5000);
