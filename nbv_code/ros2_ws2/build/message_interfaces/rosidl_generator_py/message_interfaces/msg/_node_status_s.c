...
bool message_interfaces__msg__node_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
PyObject * message_interfaces__msg__node_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("message_interfaces.msg._node_status");
